      ...
      >
        ...
        <div class="relative min-h-[60px]">
          <div
            ...
            // @ts-expect-error
            autocomplete="off"
            // Built as a JS string, not a JSX attribute, so the CSS escape in
            // content-['\\200B'] (a zero-width space, which keeps the empty
            // editor from collapsing) is written as an explicit backslash. As a
            // raw JSX attribute the leading \\200 reads as a deprecated octal
            // escape and fails lint. The emitted class is byte-identical.
            class={
